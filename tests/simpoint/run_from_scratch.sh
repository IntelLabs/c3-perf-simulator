...
if [[ "$CONFIG" == "base" ]]; then
  C3_OPT="--cpu-type=O3_X86_icelake_base"
elif [[ "$CONFIG" == "c3" ]]; then
  C3_OPT="--cpu-type=O3_X86_icelake_c3 -e $GEM5_PATH/c3_no_wrap_enable.env"
elif [[ "$CONFIG" == "c3-predtlb" ]]; then
  C3_OPT="--cpu-type=O3_X86_icelake_c3 -e $GEM5_PATH/c3_no_wrap_enable.env --enablePredTLB"
else
